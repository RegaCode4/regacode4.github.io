...
import { Github, ArrowRight, Sparkles, Terminal, Code2, Heart } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-800'}`}>
          ...
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
            ...
            <div className="space-y-2">
              ...
              <motion.h2
                ...
                className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-display font-black tracking-tighter text-slate-950 dark:text-white leading-[0.9] uppercase block"
              >
                WEB DEVELOPER
              </motion.h2>
            </div>
            ...
            >
              Saya adalah perancang aplikasi web yang berfokus pada visual interaktif berkecepatan tinggi, optimasi basis data relasional, dan penulisan kode modern yang lincah dan reusable.
            </motion.p>
      ...
      {/* About Me Section */}
      <section id="about" className="py-24 bg-white dark:bg-slate-950 border-t border-slate-200/50 dark:border-slate-800/50 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative bg-slate-900 border border-slate-800 rounded-3xl p-8 md:p-10 text-white space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-slate-300 tracking-wider uppercase">// core_credentials</h3>
                  </div>
                </div>

                <div className="space-y-4 font-mono text-xs leading-relaxed text-slate-350">
                  <p>
                    <span className="text-emerald-400">const</span> developer = <span className="text-amber-400">{`{`}</span>
                    <br />
                    <span className="pl-4">name:</span> <span className="text-emerald-300">'Adip Habibullah'</span>,
                    <br />
                    <span className="pl-4">role:</span> <span className="text-emerald-300">'Full Stack Web Developer'</span>,
                    <br />
                    <span className="pl-4">focus:</span> <span className="text-emerald-300">'Microservices & Custom UI'</span>,
                    <br />
                    <span className="pl-4">available:</span> <span className="text-amber-400">true</span>
                    <br />
                    <span className="text-amber-400">{`}`}</span>;
                  </p>

                  <p>
                    <span className="text-fuchsia-400">function</span> <span className="text-sky-400">isHirable</span>() <span className="text-amber-400">{`{`}</span>
                    <br />
                    <span className="pl-4 text-fuchsia-400">return</span> <span className="text-sky-450 font-semibold">developer.available</span>;
                    <br />
                    <span className="text-amber-400">{`}`}</span>
                  </p>
                </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm md:text-base leading-relaxed">
                Halo, saya Adip Habibullah. Saya adalah seorang Full Stack Web Developer yang mendedikasikan waktu saya untuk mempelajari pola arsitektur pengembangan web modern. Saya memiliki hasrat besar untuk mengubah tantangan bisnis nyata menjadi solusi piranti lunak berkelas industri.
              </p>
              <p className="text-slate-600 dark:text-slate-400 text-sm md:text-base leading-relaxed">
                Dengan mengintegrasikan logika back-end NodeJS/PostgreSQL berkemampuan tinggi dengan kehalusan navigasi front-end React, setiap produk yang saya rakit dirancang untuk memaksimalkan performa, keamanan end-to-end, dan kenyamanan layar pengguna.
              </p>

              {/* Pillars list */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                <div className="flex gap-3">
                  <div className="h-6 w-6 rounded-full bg-emerald-500/10 text-emerald-500 flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs">✓</div>
                  <div>
                    <h4 className="text-sm font-bold text-slate-950 dark:text-white">Clean Architecture</h4>
                    <p className="text-xs text-slate-500 mt-0.5">Struktur kode solid & redundansi super rendah.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="h-6 w-6 rounded-full bg-emerald-500/10 text-emerald-500 flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs">✓</div>
                  <div>
                    <h4 className="text-sm font-bold text-slate-950 dark:text-white">Performance Audit</h4>
                    <p className="text-xs text-slate-500 mt-0.5">Optimasi caching PostgreSQL dan query terindeks.</p>
                  </div>
                </div>
              </div>
            </div>
